...
1. Modify TwitterFunTopology.java: Define your Twitter query (location and topic based). See our (Github wiki)[https://github.com/kantega/storm-twitter-workshop/wiki] Run your  twe  
